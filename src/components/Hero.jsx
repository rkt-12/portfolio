    ...
    <section className="pt-28 lg:pt-36" id='home'>
        <div className='container items-center lg:grid lg:grid-cols-2 lg:gap-10'>
            <div>
                ...
                <div className="flex items-center gap-3">
                    <button className='bg-sky-400 text-zinc-900 p-3 rounded-2xl font-semibold cursor-pointer' onClick={() => window.open("https://drive.google.com/file/d/1GhcX8on1SVLXE7Uffd-yKT4BoypBixE5/view?usp=sharing", "_blank")}>Download CV &#9698;</button>
