...
const socialLinks = [
  ...
  },
  {
    ...
    icon: <img width="25" height="25" src="https://img.icons8.com/office/40/phone-disconnected.png" alt="phone-disconnected"/>,
    alt: 'call'
  },
  {
  ...
  {
    href: 'https://codeforces.com/profile/rmpmm',
    icon: <img width="24" height="24" src="https://img.icons8.com/external-tal-revivo-shadow-tal-revivo/24/external-codeforces-programming-competitions-and-contests-programming-community-logo-shadow-tal-revivo.png" alt="external-codeforces-programming-competitions-and-contests-programming-community-logo-shadow-tal-revivo"/>,
    alt: 'Codeforces'
  },
  {
    href: 'https://leetcode.com/u/rkt12',
    icon: <img width="24" height="24" src="https://img.icons8.com/external-tal-revivo-color-tal-revivo/24/external-level-up-your-coding-skills-and-quickly-land-a-job-logo-color-tal-revivo.png" alt="external-level-up-your-coding-skills-and-quickly-land-a-job-logo-color-tal-revivo"/>,
    alt: 'LeetCode'
  },
];
        ...
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
                    Get in touch to explore your project goals and kick off something great together!
                </p>
            ...
            <form action="https://getform.io/f/bnlqvnqb" className="xl:pl-20 2xl:pl-20" method='POST'>
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        <label htmlFor="name" className="label">Name</label>
                        <input type="text" className="text-field" id='name' name='name' autoComplete='name' required placeholder='Your name'/>
                    </div>
                    <div className="mb-4">
                        <label htmlFor="email" className="label">e-mail</label>
                        <input type="email" className="text-field" id='email' name='email' autoComplete='email' required placeholder='your e-mail '/>
                    </div>
                </div>
                <div className="mb-4"> 
